...
- For the dedicated YC8-1 chi-512 campaign, use launcher 2.6.0
  ...
  background daemon.
- The only Phase 1 exception to sequential VUMPS is the SHA-pinned final
  chi-512 control generated by `scripts/prepare_phase1_chi512_parallel_control.jl`.
  It retries only theta/pi=0.15 from accepted parent SHA-256
  `f71fc084883ea98535e012801d47c2c0b3c0b5ce58e08c72592e46410a27b7cc`
  with parallel updates and rejected-state best-iterate preservation. Do not
  generalize the flag. A scientific numerical failure triggers iDMRG planning;
  timeout, node, scheduler, or process failure is inconclusive.
