...
function main(C, J2, maxdim, δt, η)
    for L in 24:6:42
        Δ1 = 1.0
        Δ2 = 1.0

        filename = "/pscratch/sd/k/kwang98/QSL/C$(C)_L$(L)_J$(J2)_1Delta$(Δ1)_2Delta$(Δ2)_chi$(maxdim)_dt$(δt).h5"
        newfile = "processed_data/C$(C)_L$(L)_J$(J2)_1Delta$(Δ1)_2Delta$(Δ2)_chi$(maxdim)_dt$(δt).h5"
